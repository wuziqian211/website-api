...
const handler = async (req, res) => {
  ...
  try {
    ...
    if (type === 1) { // 编号为AV号或BV号
      ...
      const states = { 0: '该视频已开放浏览', 1: '该视频通过审核，但可能会受到限制', '-1': '该视频正在审核', '-2': '该视频已被退回', '-3': '该视频已被锁定', '-4': '该视频已被锁定', '-5': '该视频已被锁定', '-6': '该视频正在审核', '-7': '该视频正在审核', '-8': '该视频正在审核', '-9': '该视频正在审核', '-10': '该视频正在审核', '-11': '该视频在投稿时可能出现问题，没有发布', '-12': '该视频在投稿时可能出现问题，没有发布', '-13': '该视频在投稿时可能出现问题，没有发布', '-14': '该视频已被 UP 主删除', '-15': '该视频正在审核', '-16': '该视频在投稿时可能出现问题，没有发布', '-20': '该视频没有投稿', '-30': '该视频正在审核', '-40': '该视频已审核通过，但没有发布', '-100': '该视频已被 UP 主删除' }; // 来自https://github.com/SocialSisterYi/bilibili-API-collect/blob/master/docs/video/attribute_data.md
      let json;

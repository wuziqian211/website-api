...
export default async (req, res) => {
  ...
  try {
    ...
    if (type === 1) { // 编号为AV号或BV号
      ...
      如果您想下载视频，最好使用其他工具哟 awa`, vid: req.query.vid});
        ...
        if (accept === 1) { // 客户端想要获取类型为“文档”的数据，返回HTML
          switch (json.code) {
            case 0:
              res.status(200);
              const T = {1: "动画", 3: "音乐", 4: "游戏", 5: "娱乐", 11: "电视剧", 13: "番剧", 17: "单机游戏", 19: "Mugen", 20: "宅舞", 21: "日常", 22: "鬼畜调教", 23: "电影", 24: "MAD·AMV", 25: "MMD·3D", 26: "音MAD", 27: "综合", 28: "原创音乐", 29: "三次元音乐", 30: "VOCALOID·UTAU", 31: "翻唱", 32: "完结动画", 33: "连载动画", 36: "科技", 37: "人文·历史", 39: "演讲·公开课", 47: "短片·手书·配音", 51: "资讯", 54: "OP/ED/OST", 59: "演奏", 65: "网络游戏", 71: "综艺", 75: "动物圈", 76: "美食圈", 83: "其他国家", 85: "短片", 86: "特摄", 95: "数码", 96: "星海", 98: "机械", 119: "鬼畜", 121: "GMV", 122: "野生技术协会", 124: "趣味科普人文", 126: "人力VOCALOID", 127: "教程演示", 129: "舞蹈", 130: "音乐选集", 131: "Korea相关", 136: "音游", 137: "明星", 138: "搞笑", 145: "欧美电影", 146: "日本电影", 147: "华语电影", 152: "官方延伸", 153: "国产动画", 154: "三次元舞蹈", 155: "时尚", 156: "舞蹈教程", 157: "美妆", 158: "服饰", 159: "资讯", 160: " 生活", 161: "手工", 162: "绘画", 163: "运动", 164: "健身", 165: "广告", 166: "广告", 167: "国创", 168: "国产原创相关", 169: "布袋戏", 170: "资讯", 171: "电子竞技", 172: "手机游戏", 173: "桌游棋牌", 174: "其他", 175: "ASMR", 176: "汽车", 177: "纪录片", 178: "科学·探索·自然", 179: "军事", 180: "社会·美食·旅行", 181: "影视", 182: "影视杂谈", 183: "影视剪辑", 184: "预告·资讯", 185: "国产剧", 187: "海外剧"};
      ...
      ` : ''}<strong class="mark">分区：</strong>${utils.encodeHTML(json.data.tname)}${T[json.data.tid] ? ` &gt; ${T[json.data.tid]}` : ''}<br />

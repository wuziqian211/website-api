    ...
    switch (req.query.id) {
      ...
      case 'friends':
        const friends = [12767, 72104, 3090720, 8047632, 12633437, 35698830, 37098548, 37544886, 85819912, 96240239,
                         98787659, 106286557, 185273255, 198316802, 282022569, 286202861, 291098307, 295389941, 298030824, 322989832,
                         324042405, 333655227, 343836794, 346030399, 350611270, 354097337, 354758619, 355778940, 358201006, 361417173,
                         363763511, 374807175, 384755513, 385638250, 389623999, 389874232, 395253454, 397872234, 398217201, 400067046,
                         404658588, 405966864, 413092448, 415240328, 424674753, 425503913, 429986248, 430942433, 430967737, 432258909,
                         433751453, 433849994, 434605889, 438586165, 440004933, 444281310, 446836354, 448189858, 449328503, 451918909,
                         453521951, 453899463, 454258954, 454719152, 455568817, 455591101, 457843315, 473999894, 474683920, 474899885,
                         479611798, 480015861, 481731410, 481823642, 485821637, 492935673, 496300862, 503577862, 505570512, 506418994,
                         510272506, 512787858, 513778858, 515586861, 518970483, 519795342, 521209706, 523423693, 526705577, 527630206,
                         535362423, 589865539, 597242903, 598397900, 624532985, 1498694594, 1980000209, 2095498218];
        var info = [];
        const get = users => {
          if (users.length > 0) {

...
// 3. 朋友列表
const friends = [ // 共 254（正常用户）＋6（已注销）＝260 位用户（每个 UID 后面的注释为最近一次更新此数据时 UID 对应用户的昵称）
  12767, // 艹
  72104, // 苏白
  3090720, // UMKII
  8047632, // 哔哩哔哩弹幕网
  ...
  3493280641714839, // 一之濑水原
  3494355316770879, // 唯念那抹少年蓝鸣浩
// 已经注销，但曾经和 wuziqian211 存在一定关系的朋友有这些（UID 后面的注释为注销前被大多数人所熟悉的昵称，不等同于注销前最后使用的昵称）：
  350611270, // 生日快乐是个呆瓜（新号 UID：406599529）
  424674753, // SL_拾壹（尚未找到新号）
  475409751, // MC_小高（新号 UID：1768239812）
  486081918, // 青岛皓资商贸有限公司（据说有其他账号）
  1721464338, // Succuba-魔女（新号 UID：1642793153）
  1307861343, // 泽哥与你（尚未找到新号）
// ……

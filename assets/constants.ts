...
// 3. 朋友列表
export const friends = [ // 共 304（正常用户）＋14（已注销）＝318 位用户
  // 正常用户（每个 UID 后面的注释为最近一次更新此数据时 UID 对应用户的昵称）
  12767, // 艹
  72104, // 苏白
  3090720, // UMKII
  8047632, // 哔哩哔哩弹幕网
  12633437, // AungKyaukZaw_
  14182567, // 丸山彩萌萌哒
  22000661, // EthanYyx
  26596074, // Jiuwenzi_
  33510888, // 绫罗绫罗酱w
  ...
  479906059, // 往来霜雪
  480015861, // 百九十四
  480729923, // 咕子曲奇SnailCookie
  481731410, // 0nBYhb4电视版
  481823642, // 程序媛你说句话呀

// 常量定义
import type { url, officialType, officialRole, mediaType, mediaTypeName } from './types.d.ts';
...
export const zones: Zone[] = [ // “expired: true” 属性表示该分区已下线
  {
...
// 5. 番剧类型
export const mediaTypes = new Map<mediaType, mediaTypeName>([
  [1, '番剧'],
  [2, '电影'],
  [3, '纪录片'],
  [4, '国创'],
...
// 6. 朋友列表
export const friends = [ // 共 342（正常用户）＋17（已注销）＝359 位用户
  // 正常用户（每一项为用户的 UID，注释为最近一次更新此数据时用户的昵称）
  12767, // 艹
  72104, // 苏白
  3090720, // UMKII
  8047632, // 哔哩哔哩弹幕网
  ...
  363763511, // 热爱生活的CM君
  363870923, // 云宿山川
  367277357, // lesoleiletlalune
  372836503, // 可受的猪灵
  374807175, // 爱丽丝囚徒__
  379240063, // dontkillwitzzeni
  384068618, // 栀子东方
  ...
  429986248, // Ryan650
  430278946, // CnSywFRD
  430641434, // 淺墨影梭Nyct0yer
  430942433, // 衷曲明断几回聞
  430967737, // KiskaTech_
  431227618, // 自律no神
  432258909, // 顾云淮
  432796655, // 二次元小N
  ...
  589865539, // 曲悠赋鄉_
  592308904, // 原子电锯小子
  597242903, // TO_Castorice
  598397900, // 悠然晓冰
  608864924, // 北浅_awa
  624532985, // 久侘
  626699149, // 青柠ウア
  628092353, // 菌哥电影
  629259073, // lonelyrascalG
  645769214, // Session小胡
  646061108, // 小熊爱吃草莓_退网
  646930214, // 爱过想喝烧仙草
  647403484, // 星海_Online
  ...
  1694284021, // 暂时不怎么上线
  1697970104, // MSPaint_Music
  1729378239, // 梓艾HK
  1768239812, // 陌玖XG
  1783874124, // RU戏くん
  1831775732, // -Fuhrer-
  1845972056, // 小风真好吃
  1857780576, // 半妖half-demon
  1860533762, // 4无名氏4
  1886591057, // 梓漓吖
  1897235551, // 森岛帆高-__-
  1929820979, // 茄子MN
  ...
  3493111898573505, // 昼宝爱听歌
  3493127012747950, // 麻花儿y
  3493141707492206, // Roxy洛琪希QWQ
  3493263004665908, // 林深秋时见鹿
  3493274977306954, // Stard_UST
  3493280641714839, // 和慄薰子
  3493295483259180, // Serein-raw
  3494362101057561, // 渐染星辰
  3537113943378720, // Z_罗纳尔多
  3546382189202037, // 新世界以太NewoEther
  ...
  3546686133635653, // 春无真物
  3546693802920913, // xxx正在侵入中
  3546829132139119, // _Dynamic3_
  3546896738028019, // 婉柔姐姐在武汉
  3546953021393181, // 凛鸢旧恸
  3690978279951158, // 繁花又落雪
  // 已经注销，但曾经和梦春酱存在一定关系的朋友（梦春酱希望能有缘再见到 TA 们 (´。＿。｀)）
  ...
  513634638, // tr3n1_
  1110936584, // 宽带山自媒工作室
  1269769887, // JL_媛儿（新号 UID：3690978279951158）

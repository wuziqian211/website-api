...
<html lang="zh-CN">
  ...
  <body>
    ...
    <footer>
      ...
      执行耗时 <span class="ttime">${Date.now() - st}</span> ms<br />
      本站已稳定运行 <span class="rtime">${getTime(Date.now() / 1000 - 1636619300)}</span>
    </footer>
    <script>
      ...
      setInterval(() => rtime.innerText = getTime(Date.now() / 1000 - 1636619300), 1000);
    </script>
  </body>
</html>`;

...
const markText = str => typeof str === 'string' ? str.replace(/(BV|bv|Bv|bV)(1[1-9A-HJ-NP-Za-km-z]{2}4[1-9A-HJ-NP-Za-km-z]1[1-9A-HJ-NP-Za-km-z]7[1-9A-HJ-NP-Za-km-z]{2})/, '<a target="_blank" rel="noopener external nofollow noreferrer" href="https://www.bilibili.com/video/BV$2/">$1$2</a>').replace(/(av(\d+))/gi, '<a target="_blank" rel="noopener external nofollow noreferrer" href="https://www.bilibili.com/video/av$2/">$1</a>').replace(/(md(\d+))/gi, '<a target="_blank" rel="noopener external nofollow noreferrer" href="https://www.bilibili.com/bangumi/media/md$2">$1</a>').replace(/(ss(\d+))/gi, '<a target="_blank" rel="noopener external nofollow noreferrer" href="https://www.bilibili.com/bangumi/play/ss$2">$1</a>').replace(/(ep(\d+))/gi, '<a target="_blank" rel="noopener external nofollow noreferrer" href="https://www.bilibili.com/bangumi/play/ep$2">$1</a>') : '';

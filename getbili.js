...
img {
  ...
  <body>
    ...
    <p>${d.content}</p>
    <form action="/getbili.js" method="GET"><label for="mid">请输入要获取用户信息的 UID：</label><input type="text" name="mid" id="mid" value="${d.mid}" autocomplete="off"><input type="submit" value="获取"></form>
